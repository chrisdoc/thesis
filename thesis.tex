...
\begin{figure}
\begin{tabular}{cc}
  \includegraphics[width=65mm]{./images/tattipath0} 
  &   \includegraphics[width=65mm]{./images/tattipath1} \\
(a) first & (b) second \\[6pt]
 \includegraphics[width=65mm]{./images/tattipath2} 
 &   \includegraphics[width=65mm]{./images/tattipath3} \\
