...
The presented results have shown that cellular network subscriber trajectories can be generated for the purpose of mobility simulations. They are well-suited to describe the subscribers' mobility since they cover the traveled route and the velocity.
