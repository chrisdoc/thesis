...
\author{Christoph~ Kieslich %~\IEEEmembership{Member,~IEEE,}
        and~Gerald~Ostermayer%~\IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem C. Kieslich and G. Ostermayer are with the RG Mobile Radio Networks, UAS Upper Austria, Hagenberg, Austria\protect\\
