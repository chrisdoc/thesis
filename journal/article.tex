...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                     %%
%%  LaTeX template for BioMed Central  %%s
...
\begin{frontmatter}
	...
	\begin{fmbox}
		...
		\author[
			...
			email={christoph.kieslich@fh-hagenberg.at}   % email address
		]{\inits{C}\fnm{Christoph} \snm{Kieslich}}
		\author[
			addressref={aff1},           
			email={gerald.ostermayer@fh-hagenberg.com}
		]{\inits{G}\fnm{Gerald} \snm{Ostermayer}}
		...
		\address[id=aff1]{%                           % unique id
			\orgname{RG Mobile Radio Networks, UAS Upper Austria}, % university, etc
			\street{Softwarepark 11},                     %
			%\postcode{}                                % post or zip code
			\city{Hagenberg im Mühlkreis},                              % city
			\cny{Austria}                                    % country
		}
...
\begin{backmatter}
	...
	\begin{figure}[h!]
		\label{fig:handover}
		\caption{\csentence{Handover sorts} A overlapping handover (a) and an unconnected handover are depicted together with the estimate handover position (red point)
		}
	...
	\begin{figure}[h!]
		...
		\caption{\csentence{Handover deviations} A comparison of handover deviations between the real handover position and the estimated one with the three coverage estimation methods (P coverage prediction, PB coverage prediction with buildings and V Voronoi)
		}
	...
	\begin{figure}[h!]
		\label{fig:velocity}
		\caption{\csentence{Velocity without adaption} The estimated velocity for all three coverage estimation methods (P coverage prediction, PB coverage prediction with buildings and V Voronoi) without the adaption algorithm
		}
	...
	\begin{figure}[h!]
		...
		\caption{\csentence{Velocity with adaption} The estimated velocity for all three coverage estimation methods (P coverage prediction, PB coverage prediction with buildings and V Voronoi) with the adaption algorithm
		}
	...
	\begin{table}[h]
		...
		\begin{tabular}{|c|c|c|c|}
			...
			1                   & 48.28105,14.30415        & 48.33499,14.3780       & 22                       \\ %563
			2                   & 48.31616,14.29052        & 48.28169,14.30275      & 17                       \\  %1058
			3                   & 48.13993,16.32367        & 48.19880,16.25597      & 16                       \\ %367
			4                   & 48.19283,16.27260        & 48.15278,16.30172      & 27                       \\  \hline %144
		\end{tabular}
		\label{table:tracks}
	\end{table}
	...
	\begin{table}[h]
		\sisetup{round-mode=places,round-precision=3}% hier ggf. anpassen! (siehe siunitx-Anleitung)
		...
		\begin{tabular}{|c|c|S|S|S|S|S|S|}
			\hline
			\textbf{$\#$} & \textbf{M} & \bfseries$\min$ & \textbf{$Q_1$} & \textbf{$\tilde{x}$} & \textbf{$\bar{x}$} & \textbf{$Q_3$} & \textbf{$\max$} \\ \hline
	...
	\begin{table}[h]
		...
		\begin{tabular}{|c|p{2cm}|c|c|c|c|}
			...
			1                   & Prediction               & 42.37        & 62.60         & 23.36             & 31.51              \\  \hline %563
			1                   & Prediction with Building & 50.32        & 69.98         & 23.13             & 29.14              \\  \hline  %1058
			1                   & Voronoi                  & 59.70        & 85.55         & 17.65             & 25.25              \\  \hline%367
			2                   & Prediction               & 81.30        & 138.71        & 8.97              & 16.05              \\ \hline %563
			2                   & Prediction with Building & 60.96        & 99.09         & 9.44              & 12.09              \\   \hline%1058
			2                   & Voronoi                  & 113.99       & 181.85        & 13.03             & 16.93              \\  \hline %367
			3                   & Prediction               & 21.13        & 26.81         & 13.31             & 17.80              \\   \hline%563
			3                   & Prediction with Building & 26.38        & 33.79         & 11.94             & 16.61              \\   \hline%1058
			3                   & Voronoi                  & 28.45        & 40.09         & 13.04             & 18.78              \\  \hline%367
			4                   & Prediction               & 58.43        & 150.20        & 17.08             & 22.00              \\  \hline%563
			4                   & Prediction with Building & 48.061       & 125.75        & 14.55             & 17.79              \\   \hline%1058
			4                   & Voronoi                  & 72.72        & 191.04        & 15.39             & 21.60              \\  \hline %144
		\end{tabular}
		\label{table:results}
	\end{table}
